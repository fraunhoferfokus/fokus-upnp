 ...
 */
public class BinaryDeviceSocketStructureManagement extends SocketStructureManagement
{

  /**
   * Creates a new instance of BinaryDeviceSocketStructureManagement.
   * 
   * @param preferredHostAddressList
   * @param ignoredHostAddressList
   */
  public BinaryDeviceSocketStructureManagement(Vector preferredHostAddressList, Vector ignoredHostAddressList)
  {
  ...
  {
    BinaryDeviceHostAddressSocketStructure hostAddressSocketStructure =
      new BinaryDeviceHostAddressSocketStructure(hostAddress);
