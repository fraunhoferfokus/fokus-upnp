...
/**
 * This class holds all permissions for one subject for a specific device. It contains a list of
 * ACLEntries.
 * 
...
public class SubjectPermissions
{
  ...
  // private Vector ACLEntryList;

  /** Creates a new instance of SubjectPermissions */
  public SubjectPermissions(String subject)
  {
    this.subject = subject;
    // ACLEntryList = new Vector();
  }
