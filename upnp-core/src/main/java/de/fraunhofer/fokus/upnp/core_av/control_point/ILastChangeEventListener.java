...
public interface ILastChangeEventListener extends EventListener
{

  /**
   * Event that a state variable has been changed.
   * 
   * @param cpService
  ...
  /**
   * Event that a channel-related state variable has been changed.
   * 
   * @param cpService
   *          The associated service
   * @param instanceID
