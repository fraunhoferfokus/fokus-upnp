 ...
 * 
 * Deprecated. Use IPHelper instead.
 * 
...
public class IPAddress
{
  ...
  public static Vector getSocketStructureNetworkInterfaces()
  {
    ...
    {
      Portable.println("GetNetworkInterfaces error: " + e1.getMessage());
    } catch (Error e1)
    {
      Portable.println("GetNetworkInterfaces error: " + e1.getMessage());
    }
  ...
  public static InetAddress getLocalHostAddress()
  {
    ...
    try
    {
      ...
      System.out.println("Local host is " + localHost.getHostAddress());
      System.out.println("Local host name is " + localHost.getHostName());
    } catch (Exception e)
    {
    }
    Vector networkInterfaces = getSocketStructureNetworkInterfaces();
  ...
  {
    String localHostName = getLocalHostName().toLowerCase();
