...
public interface IDeviceGUIContextProvider
{

  /**
   * Returns a specific device context.
   * 
   * @param index
   *          The requested index
   * 
   * @return The requested context or null
   */
  public DeviceGUIContext getDeviceContext(int index);

  /**
   * Returns a device context for a specific device.
   * 
   * @param device
   *          The device
   * 
  ...
  /**
   * Returns a device context for a specific service.
   * 
   * @param service
   *          The service
   * 
  ...
  /**
   * Returns the number of available device context objects.
   * 
   * @return The number of device context objects
   */
