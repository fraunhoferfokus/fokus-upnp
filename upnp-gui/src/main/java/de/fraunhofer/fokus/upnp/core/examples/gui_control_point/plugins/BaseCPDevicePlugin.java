...
/**
 * This class is the base class for plugins for a specific device.
 * 
 * @author Alexander Koenig
 */
public class BaseCPDevicePlugin extends BaseCPServicePlugin
{

  private static final long serialVersionUID = 1L;

  /** Device associated with this plugin */
  protected CPDevice        device           = null;
  ...
  {
    return frame != null && device != null && controlPoint != null;
  }
  ...
  public void setCPDevice(CPDevice device)
  {
    this.device = device;
