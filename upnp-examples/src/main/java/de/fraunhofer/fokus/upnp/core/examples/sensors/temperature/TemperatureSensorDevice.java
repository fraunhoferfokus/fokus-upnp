 ...
 */
public class TemperatureSensorDevice extends TemplateDevice
{
  ...
  /** UPnP temperature service */
  private TemperatureSensor    temperatureSensor;

  /**
   * Creates a new instance of TemperatureSensorDevice.
   * 
   * @param anEntity
   * @param startupConfiguration
   * @param temperatureProvider
   */
  public TemperatureSensorDevice(TemplateEntity anEntity,
  ...
  {
    // set to true because the temperature provider must be known prior to calling
    // initDeviceContent()
    return true;
  }
  ...
  {
    temperatureSensor.temperatureChanged(temperature);
  }
