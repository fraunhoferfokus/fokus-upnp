...
public class RadioPlaylistDevice extends TemplateDevice
{

  private RadioPlaylistService playlistService;

  /**
   * Creates a new instance of PlayListDevice.
   * 
   * @param anEntity
   * @param startupConfiguration
   */
  public RadioPlaylistDevice(TemplateEntity anEntity, UPnPStartupConfiguration startupConfiguration)
  {
  ...
  public void initDeviceContent()
  {
    ...
    playlistService = new RadioPlaylistService(this);
    addTemplateService(playlistService);
