 ...
 */
public class ActiveSafetyDevice extends TemplateDevice
{

  private ActiveSafetyService activeSafetyService;

  /** Creates a new instance of ActiveSafetyDevice */
  public ActiveSafetyDevice(TemplateEntity anEntity, UPnPStartupConfiguration startupConfiguration)
  {
  ...
  public void initDeviceContent()
  {
    ...
    setIconList(new DeviceIcon[] {
      new DeviceIcon("image/gif", 32, 32, 8, "active_safety_icon.gif")
    });
    ...
    activeSafetyService = new ActiveSafetyService(this);
    addTemplateService(activeSafetyService);
  }
