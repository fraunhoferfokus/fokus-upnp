...
/**
 * This interface does the actual work for the SwitchPower service
 * 
 * @author Alexander Koenig
 */
public interface ISwitchPower
{
  /** Sets the value in the connected hardware */
  public void setTarget(String upnpServiceID, boolean state);

  /** Retrieves the current status of the connected hardware */
